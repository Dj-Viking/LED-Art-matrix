...
export const MOCK_PRESETS: IDBPreset[] = [
    ...
    { displayName: "", presetName: "dm5", animVarCoeff: "64", _id: "6200149468fe291e26584e50" },
    {
        ...
        presetName: "bogus",
        animVarCoeff: "64",
        _id: "6200149468fe291e26584e51",
    },
    {
        displayName: "bogus1",
        presetName: "bogus1",
        animVarCoeff: "64",
        _id: "6200149468fe291e26584eaf",
    },
    {
        displayName: "bogus2",
        presetName: "bogus2",
        animVarCoeff: "64",
        _id: "6200149468fe291e26584e14",
    },
    {
        displayName: "bogus3",
        presetName: "bogus3",
        animVarCoeff: "64",
        _id: "6200149468fe291e26584e15",
    },
    {
        displayName: "bogus4",
        presetName: "bogus4",
        animVarCoeff: "64",
        _id: "6200149468fe291e26584e16",
    },
    {
        displayName: "bogus5",
        presetName: "bogus5",
        animVarCoeff: "64",
        _id: "6200149468fe291e26584e17",
    },
];
...
export const EXPIRED_TOKEN =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzb21lVXVpZCI6IjcxNmYzMzJlLTMxODQtNDJmMC04Y2I3LTRjOWNlNmJmODdkOCIsInVzZXJuYW1lIjoidGVzdC11c2VyIiwiZW1haWwiOiJ0ZXN0QGVtYWlsLmNvbSIsIl9pZCI6IjYxZTIxMzgwNTdjOTc4NGYyNDllNjIzNSIsImlhdCI6MTY0MjIwNjA4MCwiZXhwIjoxNjQyMjA5NjgwfQ.kShMP7vYDqYvw-raT1WUq1_XVD4LgU9YsJBZ_8qAqpM";
