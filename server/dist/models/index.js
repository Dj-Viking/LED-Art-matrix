...
exports.Gif = exports.Order = exports.Category = exports.Product = exports.SearchTerm = exports.User = exports.GifStorage = void 0;
...
const GifStorage_1 = require("./GifStorage");
...
exports.Gif = Gif;
const GifStorage = (0, typegoose_1.getModelForClass)(GifStorage_1.GifStorageClass);
exports.GifStorage = GifStorage;
